...
const { email } = persona;
const [firstAnimal] = animals; //los valores de las variables van en orden a como estan las propiedades
console.log(email);
console.log(firstAnimal);
...
//Si queremos omitir la primera direccion y solo queremos la ciudad de la segunda?
const {
  address: [, { city: london }],
} = person;
console.log(london);
